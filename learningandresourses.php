...
<head>
    ...
    <title>RZA - learning and resourses</title>
</head>
...
<div class="container">
    ...
    <div class="h1">
        <h1>Learning and Resources</h1>
        </div>

        <div class="desc">
            <p>Zoos serve as an ideal destination for families, captivating visitors with a myriad of enriching experiences tailored to all ages. Renowned for their diverse animal exhibits spanning continents, zoos offer an immersive journey into the fascinating realms of wildlife. From the majestic lions of the African savannah to the playful dolphins of the ocean depths, each exhibit provides an invaluable opportunity for children to connect with nature on a profound level.</p>
        </div>
...
<!-- this container holds the clickable imgages. this is still in a prototype phase and all the images are currently the same-->
